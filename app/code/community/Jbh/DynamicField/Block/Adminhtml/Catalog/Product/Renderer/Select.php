...
/**
 * Adminhtml_Catalog_Product_Renderer_Select Block
 * @package Jbh_DynamicField
 */
class Jbh_DynamicField_Block_Adminhtml_Catalog_Product_Renderer_Select extends Varien_Data_Form_Element_Select
{
